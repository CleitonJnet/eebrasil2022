...
class Edit extends Component
{
    ...
    public function remove()
    {
        ...
        $this->redirectRoute('fieldworker.schedules.index',$this->schedule->training_id);
    }

    public function render()
    {
        return view('livewire.field-worker.schedule.edit')->layout('layouts.app_fieldworker');
    }
}
