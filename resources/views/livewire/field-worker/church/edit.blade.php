        ...
        <x-slot name="section_body">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="shadow-md overflow-hidden sm:rounded-md">
                    <form wire:submit.prevent="churchUpdate">
                        <div class="px-4 py-5 bg-white sm:p-6 grid grid-cols-6 gap-4">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" wire:model.defer="name" name="name" id="name" placeholder="{{ __('Church name') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                @error('name') <span class="text-sm text-red-600">{{$message}}</span> @enderror
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="pastor" class="block text-sm font-medium text-gray-700">{{ __('Pastor') }}</label>
                                <input type="text" wire:model.defer="pastor" name="pastor" id="pastor" placeholder="{{ __('Pastor') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="number" wire:model.defer="zipcode" name="zipcode" id="zipcode" placeholder="{{ __('Postal code') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" wire:model.defer="contact" name="contact" id="contact" placeholder="{{ __('Contact') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" wire:model.defer="contact_phone" name="contact_phone" id="contact_phone" placeholder="{{ __('Contact Phone') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="email" wire:model.defer="contact_email" name="contact_email" id="contact_email" placeholder="{{ __('Email Address') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                ...
                                <textarea wire:model.defer="comment" name="comment" id="comment" rows="5" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{$comment}}</textarea>
                                @error('comment') <span class="text-sm text-red-600">{{$message}}</span> @enderror
                            </div>
                        </div>
                        <div class="px-4 py-3 bg-gray-600 text-right sm:px-6">
                            <x-button-submit />
                            <x-button-viewer href="{{ route('fieldworker.churches.view',$cod) }}" />
                        </div>
                    </form>
                </div>
                </div>
