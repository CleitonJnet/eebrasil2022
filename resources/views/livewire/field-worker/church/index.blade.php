<div>
    ...
    <x-slot name="navigation">
        <x-nav-link href="{{ route('fieldworker.churches.create') }}">
            {{ __('NEW CHURCH') }}
        </x-nav-link>
    </x-slot>
        ...
        <x-slot name="section_body">
            ...
            <x-table>
                ...
                <x-slot name="table_body">
                    ...
                    <tr class="hover:bg-indigo-50 cursor-pointer" onclick="window.location.replace('{{ route('fieldworker.churches.view',$church->id) }}');">
