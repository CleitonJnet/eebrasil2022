<div>
    ...
    <x-slot name="navigation">
        <x-nav-link href="{{ route('fieldworker.trainings.create') }}">
            {{ __('NEW EVENT') }}
        </x-nav-link>
        ...
        <x-slot name="section_body">
            ...
            <x-table>
                ...
                <x-slot name="table_body">
                    ...
                    <tr class="hover:bg-indigo-50 cursor-pointer" onclick="window.location.replace('{{ route('fieldworker.trainings.view',$training->id) }}');">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <a href="{{ route('fieldworker.trainings.view',$training->id) }}">
