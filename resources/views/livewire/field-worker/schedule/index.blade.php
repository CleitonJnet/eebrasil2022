<div>
    ...
    <x-slot name="navigation">
        ...
        <x-nav-link href="{{ route('fieldworker.schedules.create',$training->id) }}">
            {{ __('NEW SECTION') }}
        </x-nav-link>
    </x-slot>
        ...
        <x-slot name="section_body">
            <x-table>
                ...
                <x-slot name="table_body">
                    ...
                    <tr class="hover:bg-indigo-50 cursor-pointer" onclick="window.location.replace('{{ route('fieldworker.schedules.edit',$schedule->id) }}');">
