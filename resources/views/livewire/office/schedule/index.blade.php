<div  class="pb-12">
    ...
    <x-navigation>
        <x-slot name="navigation">
            ...
            <x-nav-link href="{{ route('office.schedules.create',$training->id) }}">
                {{ __('NEW SECTION') }}
            </x-nav-link>
        </x-slot>
    </x-navigation>
        ...
        <x-slot name="section_body">
            <x-table>
                ...
                <x-slot name="table_body">
                    ...
                    <tr class="hover:bg-indigo-50 cursor-pointer" onclick="window.location.replace('{{ route('office.schedules.edit',$schedule->id) }}');">
