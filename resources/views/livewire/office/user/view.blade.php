<div  class="pb-12">
    ...
    <x-navigation>
        <x-slot name="navigation">
            <x-nav-link href="{{ route('office.users.index') }}">
                {{ __('INDEX') }}
            </x-nav-link>
            <x-nav-link href="{{ route('office.users.edit',$user->id) }}">
                {{ __('EDIT') }}
            </x-nav-link>
        </x-slot>
    </x-navigation>
            ...
            <div class="md:grid grid-cols-5 gap-2">
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg col-span-2">
                    ...
                    <div class="flex place-content-between">
                        ...
                        <div class="flex flex-col justify-center">
                            <a href="{{ route('office.churches.view', $user->church->id) }}" class="px-6 py-2 mr-6 border rounded bg-sky-700 text-white hover:bg-sky-900">{{ __('Viewer') }}</a>
                        </div>
                    </div>
                    <div class="border-t border-gray-200">
                        <dl>
