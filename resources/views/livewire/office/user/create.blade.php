                    ...
                    <form wire:submit.prevent="userStore">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 grid grid-cols-6 gap-4">
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="date" minlength="10" maxlength="11" size="11" wire:model="birth" name="birth" id="birth" placeholder="{{ __('Birth') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-1">
                                ...
                                <select id="gender" wire:model="gender" name="gender" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    <option value="" hidden>{{ __('Select') }}</option>
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="number" wire:model="zipcode" name="zipcode" id="zipcode" placeholder="{{ __('ZIP / Postal code') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="px-4 py-3 bg-gray-600 text-right sm:px-6">
                            <x-button-submit />
                            <x-button-index href="{{ route('office.users.index') }}" />
                        </div>
