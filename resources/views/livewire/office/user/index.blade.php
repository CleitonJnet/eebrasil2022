<div>
    ...
    <x-slot name="navigation">
        <x-nav-link href="{{ route('office.users.create') }}">
            {{ __('NEW  USER') }}
        </x-nav-link>
    </x-slot>
        ...
        <x-slot name="section_body">
            ...
            <x-table>
                ...
                <x-slot name="table_body">
                    ...
                    <tr class="hover:bg-indigo-50 cursor-pointer" onclick="window.location.replace('{{ route('office.users.view',$user->id) }}');">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <a href="{{ route('office.users.view',$user->id) }}">
